            ...
            <div class="background-photo">
                ...
                <div class="middle-conts">
                    ...
                    <div class="center-conts">
                        <div>
                            <div class="center-menu-header">MEMBERSHIP</div>
                            <div class="center-menu-container">
                                <div class="center-membership">
                                    <form class="membership-conts">
                                        ...
                                        <div class="mail-anniversaries-conts">
                                            ...
                                            <div class="anniversaries-container anniversaries-container-left">
                                                <div  class="label-list">
                                                    <label for="">Anniversaries</label>
                                                </div>
                                                <input class="input-list membership-input-list" type="text" placeholder="結婚記念日、誕生日、就職祝い　等…">
                                            </div>
                                        </div>
